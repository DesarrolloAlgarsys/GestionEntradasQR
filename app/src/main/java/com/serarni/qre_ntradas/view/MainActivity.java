...
public class MainActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.reactivateTicket:{
                // redirect to login activity
                Intent intent = new Intent(this, ReactivateTicketActivity.class);
                startActivity(intent);
                break;
            }
            case R.id.ver_eventos:{
                // redirect to event activity
    ...
    private void onTicketQrReceived(String sUrlTicket) {
        ...
        DataManager.getSingleton().validateTicket(
                sUrlTicket,
                new TaskCallback<TicketValidationResult>() {
                    ...
                    public void success(@NonNull TicketValidationResult result) {
                        ...
                        snackBarView.setBackgroundColor(ContextCompat.getColor(MainActivity.this, R.color.validation_ok));
                        TextView tv = (TextView) snackBarView.findViewById(android.support.design.R.id.snackbar_text);
                        tv.setTextSize(getResources().getDimension(R.dimen.snackBarTextSize));
                        mSnackBarResult.setActionTextColor(ContextCompat.getColor(MainActivity.this, R.color.validation_ok_action));
                    ...
                    public void error(@NonNull TaskError e) {
                        ...
                        Dialog dlg = new AlertDialog.Builder(MainActivity.this, R.style.AppTheme_AlertDialogTheme_validationResult)
    ...
    private void playSoundVibrationEffect(boolean bSuccess) {
        ...
        if (bVibration){
            UtilsHelper.playVibration(
                    bSuccess?AppConstants.VIBRATION_ON_SUCCESS:AppConstants.VIBRATION_ON_ERROR,
                    this);
        }
        if (bSound){
            if (bSuccess){
